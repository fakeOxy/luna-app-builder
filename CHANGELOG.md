...
- Aggiunge modalità `personale`, `prototipo` e `pubblicazione`.
- Estende il ciclo di vita fino a manutenzione, incidenti ed eventuale dismissione.
- Aggiunge Doctor con pre-check, installazione guidata e post-check.
- Integra Expo, Supabase e Codex Security come specialisti condizionali.
